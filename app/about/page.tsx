									...
									<div className='space-y-4'>
										...
										<TextReveal delay={0.2}>
											<p className='text-gray-500 md:text-xl/relaxed dark:text-gray-400'>
												At DevConnect, our mission is to bridge the gap between talented developers
												and companies seeking technical expertise. We believe in creating meaningful
												connections that benefit both parties, fostering a community where skills
												are valued and opportunities are accessible.
											</p>
										</TextReveal>
										<TextReveal delay={0.3}>
											<p className='text-gray-500 md:text-xl/relaxed dark:text-gray-400'>
												We're committed to providing a platform that simplifies the hiring process,
												ensures fair compensation for developers, and helps companies find the
												perfect match for their technical needs.
											</p>
										</TextReveal>
									</div>
								</FadeUpSection>
							...
							<div className='mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12'>
									...
									<Card>
										...
										<CardContent>
											<p className='text-center text-gray-500 dark:text-gray-400'>
												We foster a supportive community where developers and companies can connect,
								...
								<CardAnimation>
									<Card>
										...
										<CardContent>
											<p className='text-center text-gray-500 dark:text-gray-400'>
												We build trust through transparency, security, and ensuring quality
												connections between developers and companies.
											</p>
										</CardContent>
									</Card>
								</CardAnimation>
								<CardAnimation>
									<Card>
										...
										<CardContent>
											<p className='text-center text-gray-500 dark:text-gray-400'>
												We strive for excellence in everything we do, from our platform's user
												experience to the quality of our service.
											</p>
										</CardContent>
									</Card>
								</CardAnimation>
					...
					<div className='container mx-auto px-4 md:px-6'>
						...
						<FadeUpSection delay={0.4}>
							<div className='mx-auto max-w-3xl space-y-6 py-12'>
								<p className='text-gray-500 md:text-xl/relaxed dark:text-gray-400'>
									DevConnect was founded in 2020 by Sarah Johnson, a former tech recruiter who saw
									firsthand the challenges both developers and companies faced in the hiring
									process.
								</p>
							</div>
						</FadeUpSection>
					...
					<div className='container mx-auto grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10'>
						<div className='space-y-2'>
							...
							<p className='max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400'>
								Whether you're a developer looking for your next opportunity or a company seeking
								top talent, we'd love to have you as part of our community.
							</p>
						</div>
