...
import { Bell, CreditCard, Lock, Mail, Save, User } from "lucide-react";
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Changing your account type will affect your dashboard,
                        profile, and available features.
                      </p>
                    </CardContent>
                    <CardFooter>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <p className="text-sm text-muted-foreground">
                        ...
                        All information associated with your account will be
                        permanently deleted.
                      </p>
                    </CardContent>
                    <CardFooter>
                    ...
                    <CardContent className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Receive email notifications when you get a new
                            message
                          </p>
                        </div>
                        <Switch
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Receive email notifications about your job
                            applications
                          </p>
                        </div>
                        <Switch
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Receive email notifications about scheduled
                            interviews
                          </p>
                        </div>
                        <Switch
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Receive email notifications about new job
                            opportunities
                          </p>
                        </div>
                        <Switch
                      ...
                      <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Receive email updates about DevConnect features and
                            promotions
                          </p>
                        </div>
                        <Switch
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              San Francisco, CA • Safari on iOS
                            </p>
                          </div>
                          <Button variant="outline" size="sm">
                            Revoke
                      ...
                      <div className="rounded-lg border p-4">
                        <div className="flex items-center justify-between">
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              $19/month • Renews on June 1, 2025
                            </p>
                          </div>
                          <span className="text-xs bg-green-100 text-green-800 px-2 py-1 rounded-full dark:bg-green-800 dark:text-green-100">
                            Active
