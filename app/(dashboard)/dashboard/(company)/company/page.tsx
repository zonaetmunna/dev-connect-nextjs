          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  +{analytics.newApplicants} new this week
                </p>
              </CardContent>
            </Card>
            <Card>
                ...
                {jobPostings.map((job) => (
                  <Card key={job.id}>
                    ...
                    <CardFooter className="flex flex-col md:flex-row gap-2">
                      ...
                      <Button
                        variant={
                          job.status === "Active" ? "destructive" : "default"
                        }
                ...
                <Card>
                  <CardContent className="flex flex-col items-center justify-center py-10">
                    ...
                    <p className="text-sm text-muted-foreground text-center max-w-md">
                      ...
                      Schedule interviews with your applicants to see them here.
                    </p>
                  </CardContent>
                </Card>
              )}
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Applicant progression through stages
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
