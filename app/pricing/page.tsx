      ...
      <main className="flex-1">
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto mt-8 flex w-full max-w-md flex-col items-center space-y-4">
              <Tabs defaultValue="companies" className="w-full">
                <TabsList className="grid w-full grid-cols-2">
                  <TabsTrigger value="companies">{t("pricing.tabs.companies")}</TabsTrigger>
                  <TabsTrigger value="developers">{t("pricing.tabs.developers")}</TabsTrigger>
                </TabsList>
                <TabsContent value="companies" className="mt-6">
                  <div className="grid gap-6 lg:grid-cols-3">
                    <Card className="flex flex-col">
                        ...
                        <ul className="space-y-2">
                          {t("pricing.plans.basic.features").map((feature: string, index: number) => (
                            <li key={index} className="flex items-center">
                              <Check className={`${dir === "rtl" ? "ml-2" : "mr-2"} h-4 w-4 text-primary`} />
                              <span>{feature}</span>
                            </li>
                          ))}
                        </ul>
                      ...
                      <CardFooter>
                        <Button className="w-full">{t("pricing.plans.basic.cta")}</Button>
                      </CardFooter>
                    </Card>
                    <Card className="flex flex-col border-primary">
                      <CardHeader>
                        <div className="flex items-center justify-between">
                          <CardTitle>{t("pricing.plans.professional.title")}</CardTitle>
                          <span className="rounded-full bg-primary px-2.5 py-0.5 text-xs font-semibold text-primary-foreground">
                            {t("pricing.plans.professional.badge")}
                          </span>
                        </div>
                        <CardDescription>{t("pricing.plans.professional.description")}</CardDescription>
                        <div className="mt-4 text-4xl font-bold">
                      ...
                      <CardContent className="flex-1">
                        <ul className="space-y-2">
                          {t("pricing.plans.professional.features").map((feature: string, index: number) => (
                            <li key={index} className="flex items-center">
                              <Check className={`${dir === "rtl" ? "ml-2" : "mr-2"} h-4 w-4 text-primary`} />
                              <span>{feature}</span>
                            </li>
                      ...
                      <CardFooter>
                        <Button className="w-full">{t("pricing.plans.professional.cta")}</Button>
                      </CardFooter>
                    </Card>
                    <Card className="flex flex-col">
                      <CardHeader>
                      ...
                      <CardFooter>
                        <Button className="w-full">{t("pricing.plans.enterprise.cta")}</Button>
                      </CardFooter>
                    </Card>
                  </div>
                </TabsContent>
                <TabsContent value="developers" className="mt-6">
                  <div className="grid gap-6 lg:grid-cols-3">
                    <Card className="flex flex-col">
                      ...
                      <CardContent className="flex-1">
                        <ul className="space-y-2">
                          {t("pricing.plans.free.features").map((feature: string, index: number) => (
                            <li key={index} className="flex items-center">
                              <Check className={`${dir === "rtl" ? "ml-2" : "mr-2"} h-4 w-4 text-primary`} />
                              <span>{feature}</span>
                            </li>
                      ...
                      <CardFooter>
                        <Button className="w-full">{t("pricing.plans.free.cta")}</Button>
                      </CardFooter>
                    </Card>
                    <Card className="flex flex-col border-primary">
                      <CardHeader>
                      ...
                      <CardFooter>
                        <Button className="w-full">{t("pricing.plans.pro.cta")}</Button>
                      </CardFooter>
                    </Card>
                    <Card className="flex flex-col">
                      <CardHeader>
                        <CardTitle>{t("pricing.plans.premium.title")}</CardTitle>
                        <CardDescription>{t("pricing.plans.premium.description")}</CardDescription>
                        <div className="mt-4 text-4xl font-bold">
                      ...
                      <CardContent className="flex-1">
                        <ul className="space-y-2">
                          {t("pricing.plans.premium.features").map((feature: string, index: number) => (
                            <li key={index} className="flex items-center">
                              <Check className={`${dir === "rtl" ? "ml-2" : "mr-2"} h-4 w-4 text-primary`} />
                              <span>{feature}</span>
                            </li>
                      ...
                      <CardFooter>
                        <Button className="w-full">{t("pricing.plans.premium.cta")}</Button>
                      </CardFooter>
                    </Card>
                  </div>
                </TabsContent>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl gap-6 py-12 lg:grid-cols-2">
              {t("pricing.faq.questions").map((faq: { question: string; answer: string }, index: number) => (
                <Card key={index}>
                  <CardHeader>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter md:text-4xl/tight">{t("pricing.cta.title")}</h2>
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button variant="outline">
                      <HelpCircle className={`${dir === "rtl" ? "ml-2" : "mr-2"} h-4 w-4`} />
